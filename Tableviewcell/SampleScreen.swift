...
class SampleScreen: UIViewController {
    ...
    @objc fileprivate func addUser()
    {
        do{
            ...
            let alertMessage = UIAlertController(title:"Form not be filled" , message:"Please fill all the necessary fields", preferredStyle: .actionSheet)
            alertMessage.addAction(UIAlertAction(title:"Submit",style: .default , handler : nil))
            alertMessage.addAction(UIAlertAction(title:"Cancel̥",style: .cancel , handler: nil))
